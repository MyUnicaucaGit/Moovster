...
public class AdminsSQLHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase dbMoovster) {
        ...
        dbMoovster.execSQL("CREATE TABLE Movies( movie_id INTEGER PRIMARY KEY, stars Int DEFAULT 0, views Int DEFAULT 0, fav Boolean DEFAULT false, user_email String, FOREIGN KEY (user_email) REFERENCES User (email) ON DELETE CASCADE ON UPDATE NO ACTION);");
