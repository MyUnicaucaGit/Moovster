 ...
 * Use the {@link register_user#newInstance} factory method to
...
public class register_user extends Fragment {
    ...
    public static register_user newInstance(String param1, String param2) {
        register_user fragment = new register_user();
